...
def startapp():
    ...
    evupdate.pack()
    Label(tab5, text='enter marks').pack()
    enter_marks = Entry(tab5, width=5)
    enter_marks.pack()
    Label(tab5, text='enter evaluator name').pack()
    ...
    tab_control.add(tab6, text='SHOW')
    ...
    combostudents.current(0)  # set the selected item
    combostudents.pack()

    showstudentsbttn = Button(
        tab6, text="GET STUDENT MARKS", command=showstudents)
